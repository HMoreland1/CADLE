...
import { DraggableText, DraggableTextTitle, DraggableEmail, DraggableSpacer, DraggableFlipTile} from './DraggableComponents';
...
const ComponentPalette = () => {
    return (
        <div style={{display: 'grid', gridTemplateColumns: 'repeat(auto-fit, 45%)', gap: '5%'}}>
                ...
                <DraggableFlipTile title="title" text="content"/>
        </div>
