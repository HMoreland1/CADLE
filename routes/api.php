...
Route::get('/learning-content/user/{userId}', [UserLearningController::class, 'getAllAssignedContent']);
Route::get('/learning-content/user/{userId}/complete', [UserLearningController::class, 'getAllCompletedContent']);
