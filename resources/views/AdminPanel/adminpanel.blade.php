<div class="bg-white rounded-top shadow-sm mb-4 rounded-bottom">
    ...
    <div class="row g-0">
        <div class="col col-lg-7 mt-6 p-4">
            ...
            <h3>
                Welcome to the CADLE admin panel!
            </h3>
        </div>
    ...
    <div class="row bg-light m-0 p-md-4 p-3 border-top rounded-bottom g-md-5">
        ...
        <div class="col-md-6 my-2">
            ...
            <p class="ms-md-5 ps-md-1">
                ...
                to learn how to get started with CADLE.
                Whether you're setting up your first course,
                managing user accounts, or exploring advanced features,
                our documentation provides step-by-step guides and helpful
                tips to ensure you make the most out of your CADLE experience.
                Let's kickstart your journey to cyber awareness excellence
                together!  <a href="https://orchid.software/en/docs" target="_blank" class="text-u-l">documentation</a>.
            </p>
        </div>
        ...
        <div class="col-md-6 my-2">
            <h3 class="text-muted fw-light lh-lg d-flex align-items-center">
                ...
                <span class="ms-3 text-dark">Lets Get Started</span>
            </h3>
            <p class="ms-md-5 ps-md-1">
                Use the side menu in the top left to get started.
            </p>
        </div>
